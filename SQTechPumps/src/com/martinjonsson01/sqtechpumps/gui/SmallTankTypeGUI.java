...
public class SmallTankTypeGUI {

	Player owner;

	Machine m;

	public SmallTankTypeGUI(Machine m, Player owner) {
		this.owner = owner;
		this.m = m;
	}
	...
	public void open() {
		...
		Inventory gui = Bukkit.createInventory(owner, 27, ChatColor.BLUE + "SQTech - Choose small tank type");
