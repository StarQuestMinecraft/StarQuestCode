...
public class BioGeneratorGUI extends GUI {
	
	public BioGeneratorGUI(Player player, int id) {
	...
	public void open() {
		...
		Inventory gui = Bukkit.createInventory(owner, 27, ChatColor.BLUE + "SQTech - Bio Generator");
	...
	public void click(final InventoryClickEvent event) {
		...
		if (event.getClickedInventory() != null) {
			...
			if (event.getClickedInventory().getTitle().startsWith(ChatColor.BLUE + "SQTech")) {
				...
				if (event.getClickedInventory().getTitle().equals(ChatColor.BLUE + "SQTech - Bio Generator")) {
